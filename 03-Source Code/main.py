...
# TODO:Choose a best classier n
# TODO: handle char segmentation and word accuracy partially DONE
# TODO: impalement a logic for a testing DONE
# TODO:Convert each  la to X in text image DONE
# TODO: # of segmented words != text word (bongo)
# TODO: handle RuntimeWarning: overflow encountered in ulong_scalars DONE
...
if Model_Mode == 0:  # Training MODE
    ...
    for SegmentedWords in SegmentedWordsPerLine:
        ...
        Output_Text += "\n"
    Write_ClassifiedText(Output_Text)
    end_time = time.time()
    # TODO: make it sec
